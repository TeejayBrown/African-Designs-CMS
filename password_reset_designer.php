...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        $query = "UPDATE designers SET password = :password WHERE designerid = :designerid";
        
        if($statement = $db->prepare($query)){
            // Bind variables to the prepared statement as parameters
            $statement->bindParam(":password", $param_password, PDO::PARAM_STR);
            $statement->bindParam(":designerid", $param_id, PDO::PARAM_INT);
            
            // Set parameters
            $param_password = password_hash($new_password, PASSWORD_DEFAULT);
            $param_id = $_SESSION["designerId"];
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="nav navbar-nav navbar-right">
                    ...
                    <a class="nav-link " aria-current="page" href="design.php">Upload Design</a>
                    <a class="nav-link active" aria-current="page" href="password_reset_designer.php">Reset Password</a>
        ...
        <div class="wrapper">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-link ml-2" href="designerwelcome.php">Cancel</a>
                </div>
            </form>
        </div>
    </main>    
